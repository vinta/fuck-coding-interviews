...
- `problems/`
    - Array
        ...
        - [Shuffle the Array](https://github.com/vinta/fuck-coding-interviews/blob/master/problems/shuffle_the_array.py) from [LeetCode](https://leetcode.com/problems/shuffle-the-array/)
    ...
    - Multiset
        ...
        - [Single Number](https://github.com/vinta/fuck-coding-interviews/blob/master/problems/single_number.py) from [LeetCode](https://leetcode.com/problems/single-number/)
    ...
    - Binary Tree
        ...
        - [Binary Tree Maximum Path Sum](https://github.com/vinta/fuck-coding-interviews/blob/master/problems/binary_tree_maximum_path_sum.py) from [LeetCode](https://leetcode.com/problems/binary-tree-maximum-path-sum/)
    ...
    - Graph
        ...
        - [Course Schedule](https://github.com/vinta/fuck-coding-interviews/blob/master/problems/course_schedule.py) from [LeetCode](https://leetcode.com/problems/course-schedule/)
    - SQL
