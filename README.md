...
- `problems/`
    ...
    - [sock_merchant](https://github.com/vinta/fuck-coding-interviews/blob/master/problems/add_two_numbers.py) from [HackerRank](https://www.hackerrank.com/challenges/sock-merchant/problem)
